    ...
    return (
        <div id='navmenu' className="bg-fundo py-4 justify-between flex">
            <div className="w-ful">
                ...
                <Link href="/adm/eventos/page" className={`text-azulBase mr-10 ${router.pathname === '/adm/eventos/page' ? 'border-b-2 border-azulBase' : ''}`}>Eventos</Link>
                ...
                <Link href="/adm/egressos/page" className={`text-azulBase mr-10 ${router.pathname === '/adm/egressospage' ? 'border-b-2 border-azulBase' : ''}`}>Egressos</Link>
